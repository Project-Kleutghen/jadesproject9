...
import { Canvas, IIIFResource, LabelValuePair, Manifest, ManifestType, Range, Service, Sequence, Thumb, TreeNode } from "manifesto.js";
export declare class Helper {
    ...
    getAllRequiredStatements(): Array<ILabelValuePair & {
        source: "Range" | "Canvas" | "Manifest" | "Collection";
    }>;
    getMostSpecificRequiredStatement(): ILabelValuePair | null;
    ...
    getAccompanyingCanvasImage(): string | null;
