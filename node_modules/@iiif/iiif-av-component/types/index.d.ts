...
declare class CompositeMediaElement {
	...
	load(): Promise<void>;
	seekToMediaTime(annotationTime: AnnotationTime, _toCanvas?: string, paused?: boolean): Promise<void>;
...
export declare class CanvasInstance extends BaseComponent {
	...
	autoAdvanceRanges: boolean;
	currentRange?: string;
	setCurrentRangeId(range: null | string, { autoChanged, limitToRange, noRender, }?: {
		autoChanged?: boolean;
		limitToRange?: boolean;
		noRender?: boolean;
	}): void;
	...
	setCurrentTime(seconds: TimelineTime, external?: boolean): Promise<void>;
	setCurrentRangeTime(seconds: number, rangeId: string, external?: boolean): Promise<void>;
	now(): TimelineTime;
...
export declare class AVComponent extends BaseComponent {
	...
	reset(): void;
	private _reset;
	setCurrentTime(time: number, external?: boolean): Promise<void>;
	setCurrentRangeTime(time: number, rangeId: string, external?: boolean): Promise<void>;
...
declare function canPlayHls(): any;
...
declare function formatTime(input: number): string;
