...
exports.createTimePlansFromManifest = void 0;
const relative_time_1 = require("./relative-time");
function createTimePlansFromManifest(manifest) {
    const parseRange = (range, _rangeStack = [], startDuration = (0, relative_time_1.timelineTime)(0)) => {
        ...
        const timePlan = {
            type: 'time-plan',
            canvases: [],
            duration: (0, relative_time_1.timelineTime)(0),
            items: [],
            stops: [],
            rangeOrder: isNoNav ? [] : [rangeId],
            end: (0, relative_time_1.timelineTime)(0),
            start: startDuration,
            rangeId: rangeId,
        ...
        for (let canvasIndex = 0; canvasIndex < rangeRanges.length; canvasIndex++) {
            ...
            if (typeof ro === 'string') {
                ...
                const rStart = (0, relative_time_1.canvasTime)(parseFloat(start || '0'));
                const rEnd = (0, relative_time_1.canvasTime)(parseFloat(end || '0'));
                const rDuration = (0, relative_time_1.timelineTime)(rEnd - rStart);
                runningDuration = (0, relative_time_1.addTime)(rDuration, runningDuration);
                const timeStop = {
                    type: 'time-stop',
                    canvasIndex: canvasIdx,
                    start: (0, relative_time_1.minusTime)(runningDuration, rDuration),
                    end: runningDuration,
                    duration: rDuration,
                    rangeId: rangeId,
                    canvasId: canvasId,
                ...
                const rangeTimePlan = parseRange(ro, [...rangeStack, ro.id], runningDuration);
                runningDuration = (0, relative_time_1.addTime)(runningDuration, rangeTimePlan.duration);
                ...
                ...rangeTimePlan.stops.map((stop) => (Object.assign(Object.assign({}, stop), { canvasIndex: timePlan.canvases.indexOf(stop.canvasId) }))));
                timePlan.items.push(rangeTimePlan);
                timePlan.rangeOrder.push(...rangeTimePlan.rangeOrder);
            }
        }
        timePlan.end = runningDuration;
        timePlan.duration = (0, relative_time_1.timelineTime)(timePlan.end - timePlan.start);
        return timePlan;
    };
