...
declare namespace Virtex {
    class Viewport {
        ...
        createLights(): void;
        createCamera(camera?: THREE.PerspectiveCamera): void;
        private _createRenderer();
        private _setVRDisplay(vrDisplay);
        private _createDOMHandlers();
        private _loadObject(objectPath);
        private _loadingBarVisible(visible);
        private _spinnerVisible(visible);
        private _loaded(obj);
        private _getBoundingBox();
        private _getBoundingMag();
        private _getCameraZ();
        private _getFov();
